...
- Write parity follow-up started: pi-mono-style description/schema wording, explicit bytesWritten detail coverage, and actionable oversized-content result with contentBytes/maxBytes details before mutation.
- Current next high-ROI target: Batch 2 edit/write UX — continue write UX coverage, then edit CRLF/BOM/no-op/actionable errors/bounded diff metadata.
