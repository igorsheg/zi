...
check_present "read untruncated details test" "test .*read.*no details|details.*== null|details == null" src/coding_agent/tools/read.zig
...
check_present "ls case-insensitive sort" "ascii.*[tT]oLower|case.*insensitive|[tT]oLower" src/coding_agent/tools/ls.zig
