...
Zi separates run interruption, terminal exit gestures, terminal teardown, and final session disposal. They have different data-loss and resource-lifetime semantics and must not share an ambiguous `abort()` path.
