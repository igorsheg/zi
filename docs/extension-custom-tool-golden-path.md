...
The first checked-in example will be a small repository-specific tool with typed arguments and a bounded textual result. Its purpose is to be copied and changed by a person or coding agent, not to demonstrate every future extension capability.
