...
follow-on v2 contract docs define concrete seams — [runtime roots](./runtime-roots.md), [lifecycle/scheduler](./extensions-lifecycle.md), [events/interceptors](./extensions-events.md), [semantic session api](./extensions-session.md), [system command api](./extensions-system.md), [retained objects](./extensions-retained-objects.md), [tools](./extensions-tools.md), [jobs/subagents](./extensions-jobs-subagents.md), [ui contract](./extensions-ui-contract.md), [semantic ui primitives](./extensions-ui-primitives.md), [ui substrate map](./extensions-ui-substrate-map.md), [state rebinding](./extensions-state-rebinding.md), [providers](./extensions-providers.md), [commands/flags/actions](./extensions-commands-flags-actions.md), the [conformance matrix](./extensions-conformance-matrix.md), [example parity ledger](./extensions-example-parity-ledger.md), and [cutover boundaries](./extensions-cutover-boundaries.md) — while citing the root adr instead of reopening the cutover question.
