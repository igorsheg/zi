...
| B10 ESC cascade | `Loop.zig` centralized picker, session-operation, image-preparation, retry/compaction, and active-run cancellation paths; pty e2e abort coverage |
