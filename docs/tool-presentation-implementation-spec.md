...
| Subagents   | model-authored name or bounded count | task/message details or bounded completion summaries       | administrative success hidden; wait head 6            | prior close lifecycle when relevant    |
