...
| `Composer`               | one prompt component | native text/editing, atomic paste/image extmarks, and bounded session-history browsing                 |
