-- Hidden thinking label example.
-- Product-equivalent to pi-mono hidden-thinking-label.ts: customize the label
-- shown when thinking blocks are collapsed/hidden.
