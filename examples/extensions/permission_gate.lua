-- Permission gate example: block or confirm dangerous bash tool calls.
--
-- This uses zi's host-owned event boundary:
--   zi.on("tool_call", handler)
--
-- Returning { block = true, reason = ... } cancels tool execution. In an
-- interactive TUI, dangerous commands ask for confirmation via semantic prompts.
