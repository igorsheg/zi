...
const DIRECTION_AXIS = { left: "x", right: "x", up: "y", down: "y" } as const satisfies Record<
  DiagramDirection,
  DiagramAxis
>

const DIRECTION_SIGN = { left: -1, right: 1, up: -1, down: 1 } as const satisfies Record<DiagramDirection, -1 | 1>

const DIRECTION_SIDE = { left: "left", right: "right", up: "top", down: "bottom" } as const satisfies Record<
  DiagramDirection,
  DiagramSide
>

const OPPOSITE_SIDE = { left: "right", right: "left", top: "bottom", bottom: "top" } as const satisfies Record<
  DiagramSide,
  DiagramSide
>
