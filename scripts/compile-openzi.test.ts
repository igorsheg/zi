...
import { assertPinnedBunVersion, compileStandalone } from "./compile-openzi.js"

test("standalone compilation requires the workspace-pinned Bun runtime", () => {
  expect(() => assertPinnedBunVersion("1.3.5", "bun@1.3.14")).toThrow("OpenZi builds require Bun 1.3.14; running 1.3.5")
