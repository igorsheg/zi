...
pub fn defaultConvertToLlm(_: ?*anyopaque, allocator: std.mem.Allocator, messages: []const ai.protocol.AgentMessage) error{OutOfMemory}![]const ai.protocol.Message { // ziglint-ignore: Z024, Z023
...
pub const default_hook = ai.hooks.ConvertMessagesHook{ .call_fn = defaultConvertToLlm }; // ziglint-ignore: Z004
